...
def rename_categories(df):
    ...
    df.loc[df['Description'] == 'Canva', 'Category'] = 'Miscellaneous'
    df.loc[df['Description'] == 'Harris County Toll Road Authority', 'Category'] = 'Toll'
    df.loc[df['Description'] == 'Regal Gateway', 'Category'] = 'Entertainment'
    df.loc[df['Description'] == 'Hca Local Hospital Visi', 'Category'] = 'Medical'
    df.loc[df['Description'] == 'Discount Tire', 'Category'] = 'Car'
    df.loc[df['Description'] == 'Spotify', 'Category'] = 'Entertainment'
    df.loc[df['Description'] == 'Regal Gateway', 'Category'] = 'Entertainment'
    df.loc[df['Description'] == 'JW Marriott', 'Category'] = 'Hotel'
    df.loc[df['Description'] == 'Lavella Deposito Rent', 'Category'] = 'Rent'
    df.loc[df['Description'] == 'World Market', 'Category'] = 'Shopping'
    df.loc[df['Description'] == 'Lavella Deposito Rent', 'Category'] = 'Rent'
    df.loc[df['Description'] == 'Hobby Lobby', 'Category'] = 'Shopping'
    df.loc[df['Description'] == 'Bath & Body Works', 'Category'] = 'Shopping'
    df.loc[df['Description'] == 'Canva', 'Category'] = 'Canva'
    df.loc[df['Description'] == 'HomeGoods', 'Category'] = 'Shopping'
    df.loc[df['Description'] == 'Arc Mychart', 'Category'] = 'Medical'
    df.loc[df['Description'] == 'Ring', 'Category'] = 'Subscription'
    df.loc[df['Description'] == 'Nails by Itzel', 'Category'] = 'Nails'
    df.loc[df['Description'] == 'Pettable.com', 'Category'] = 'Pets'
    ...
    df.loc[df['Description'] == 'Zelle Transfer to Daniela', 'Category'] = 'Zelle to Daniela'
